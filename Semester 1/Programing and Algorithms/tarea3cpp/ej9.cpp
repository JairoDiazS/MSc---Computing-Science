...
public:
    ...
    // Función virtual pura para obtener el número de ruedas
...
public:
    ...
    // Implementación de la función numWheels para Car
...
public:
    ...
    // Implementación de la función numWheels para Bike
    int numWheels() const override {
        // Las bicicletas tienen 2 ruedas
        return 2;
    }
...
int main() {
    ...
    // Llamar a la función displayInfo, numWheels y fuelEfficiency de cada objeto
    myCar.displayInfo();
    cout << "Número de ruedas del carro: " << myCar.numWheels() << endl;
    cout << "Eficiencia de combustible del carro: " << myCar.fuelEfficiency() << " mpg" << endl;

    myBike.displayInfo();
    cout << "Número de ruedas de la bicicleta: " << myBike.numWheels() << endl;
