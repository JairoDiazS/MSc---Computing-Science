...
int main(int argc, char **argv){
    ...
    solInterpol *sol = eval_newtonDD(pairs[0], pairs[1], 1.0, sz);
    printf("La evaluacion de la interpolacion de Newton de grado %d, en el punto 1.0 es: %lf\n", sz-1, sol->sol);
